if (sessionStorage.getItem("summaryNum") == 3) {
  ...
  qsa(".name_list li").forEach((click) => {
    click.addEventListener("click", function () {
      ...
      if (this.classList.contains("name1")) {
        directiveAudio.src = "audio/summary3/directive1.mp3";
      } else if (this.classList.contains("name2")) {
        directiveAudio.src = "audio/summary3/directive2.mp3";
      } else if (this.classList.contains("name3")) {
        directiveAudio.src = "audio/summary3/directive3.mp3";
      } else if (this.classList.contains("name4")) {
        directiveAudio.src = "audio/summary3/directive4.mp3";
      }
  ...
  directiveAudio.addEventListener("ended", function () {
    ...
    if (qsa(".name_list li.on").length == 4) {
      // 피드백 + 다음 버튼 + 10초 팝업 활성화
      playFeedback();
      sessionStorage.setItem("summaryNum", 3);
    }
  });
}
