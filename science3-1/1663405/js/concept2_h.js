...
function dropCorrect() {
  ...
  $(".quiz_area").removeClass("on").addClass("finish");
  setTimeout(function () {
...
$("#seqGif1 .gif").each(function () {
  ...
  var observer = new MutationObserver(function (mutations) {
    mutations.forEach(function (mutations) {
      if ($("#seqGif1 .gif").attr("src") === "./img/concept2_h/gif3/79.webp" && !$(".click_wrap").hasClass("on")) {
        $("#seqGif1 .gif").attr("src", "./img/concept2_h/gif3/1.webp");
        setTimeout(function () {
